...
export const translations = {
  en: {
    ...
    scheduleModal: {
      ...
      backendUnavailable: "The scheduling server is not running. Open the website with npm run dev.",
  ...
  es: {
    ...
    scheduleModal: {
      ...
      backendUnavailable: "El servidor de reservas no está activo. Abre la página usando npm run dev.",
